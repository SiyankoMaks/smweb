...
<body>
    ...
    <?php
        if(isset($_COOKIE["loginNew"])){
          $log = $_COOKIE["loginNew"];
          $pass = $_COOKIE["passwordNew"];
          setcookie("loginNew","",1000000);
          setcookie("passwordNew","",1000000);
          echo "<br>Ваш логин: $log</br>Ваш пароль: $pass<br>";
        }
    ?>
         <p><label>
           Имя:
         ...
         <p><a href="admin.php" >Вернуться к исходной странице</a></p>
       </form>
</body>
</html>
